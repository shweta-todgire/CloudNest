...
export default function LoginPage() {
  ...
  const handleGoogle = async () => {
    ...
    try {
      await signInWithGoogle(); // handles Firestore user creation internally
    ...
    <div className="min-h-screen grid md:grid-cols-2 bg-[#020817] text-white">
      ...
      <div className="hidden md:flex flex-col items-center justify-center px-10 text-center">
        ...
        <p className="text-slate-300 mt-4 max-w-md">
          Secure cloud storage with real-time sync and collaboration.
        </p>
      </div>
      ...
      <div className="flex items-center justify-center px-6 py-10">
        <div className="w-full max-w-md">
          ...
          <p className="text-slate-300 text-sm mb-6">
            Sign in to access your CloudNest
          </p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <input
                  {...register('email')}
                  className="w-full pl-10 pr-3 py-3 rounded-lg bg-white/10 border border-white/20 focus:ring-2 focus:ring-blue-500"
                />
              </div>
            ...
            <div>
              <div className="flex justify-between text-sm text-slate-300">
                <span>Password</span>
                <Link href="/auth/reset-password" className="text-blue-400">Forgot?</Link>
              </div>
